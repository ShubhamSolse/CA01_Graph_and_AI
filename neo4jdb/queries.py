...
from neo4jdb.Bus import \
    BusExecution
from neo4jdb.Dart import \
    DartExecution
from neo4jdb.Luas import \
    LuasExecution
from neo4jdb.Master_Node import \
    MasterNode
from utils.data_processing import IrishTransportData
import subprocess
from utils.evaluation import Evaluation_time_period
...
class Neo4jExecution:
    ...
    def run_streamlit_app(self):
        ...
        try:
            ...
            app_path = r"C:\Users\shubh\PycharmProjects\Graph&AI_CA1\app.py"
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "********************************************************************************************************************************************")
        print("Time predicting Evaluation...")
        iEvaluate = Evaluation_time_period()
    finally:
        # Close the Neo4j connection
